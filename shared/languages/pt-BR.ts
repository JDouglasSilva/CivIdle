export const PT_BR = {
   ...
   AccountTradeTileReservationTimeDesc: "Esse é o tempo que seu espaço de troca de jogador será reservado para você desde a ultima vez que você esteve online. Após o perioso de reserva terminar, seu espaço se tornará disponível para outros jogadores",
   ...
   Alloy: "Liga Metálica",
   Alps: "Alpes",
   AlpsDesc: "Cada 10º nível de uma construção a garante +1 de Capacidade de Produção (+1 de Multiplicador de Consumo, +1 de Multiplicador de Produção)",
   Aluminum: "Alumínio",
   ...
   CNTower: "CN Tower",
   CNTowerDesc: "Todos os estúdios de cinema, estações de rádio e estações de TV estão isentos de -1 de Felicidade. Todas as construções desbloqueadas nas Guerras Mundiais e na Guerra Fria ganham +N de Produção, Capacidade de Trabalhadores e Multiplicador de Armazenamento. N = Diferença entre o nível e a era da construção",
   Coal: "Carvão",
